			...
			<main className="bg-white ~/lg:~px-4/40 ~/lg:~py-8/16 dark:bg-gray-900">
				<section>
					...
					<div className="flex flex-col-reverse items-center justify-center gap-4 rounded-lg md:flex-row md:gap-8">
						...
						<div className="relative flex-shrink-0 overflow-hidden rounded-full border-4 border-blue-600 bg-gradient-to-b from-blue-500 ~/lg:~h-40/60 ~/lg:~w-40/60 dark:border-blue-400 md:border-8">
							<Image
								src={images.deved}
								alt=""
								layout="fill"
						...
						<div className="flex flex-col gap-8 lg:flex-row">
							...
							<div className="grid flex-1 gap-10 rounded-xl p-10 text-center shadow-lg dark:bg-white lg:grid-rows-3">
								...
								<div className="flex flex-col items-center">
									...
									<p className="py-1 font-mono dark:text-gray-800">Photoshop</p>
									<p className="py-1 font-mono dark:text-gray-800">Figma</p>
									<p className="py-1 font-mono dark:text-gray-800">Adobe XD</p>
								</div>
							</div>
